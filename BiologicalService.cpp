...
//resources basic class
void BioRes::RecycleRes(int worker,people) //how mass change
{
...
int BioRes::GetPeople(unsigned int people,int worker)
{
...
{hp=health_of_system;}
void BioRes::SetResource(int new_mass)
{mass=new_mass;}
}
                  // Resources basic class
